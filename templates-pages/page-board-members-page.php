<?php
/**
 * Template Name: Page - Board Members Page
 * Description: Displays Board Members of Peapack Gladstone Bank.
 *
 * @package WordPress
...
<div id="Content">
    ...
    <div id="hideme" class="row content">
        <div id="alltiles" class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <?php
                    $args = array( 'post_type' => 'board members' , 'posts_per_page' => 20 );
            ...
            <div class="paragraph">
                <div class="col-lg-5 col-md-5 col-sm-5">
                    <?php
                        ...
                        $loop = new WP_Query( $args );
                        while ( $loop->have_posts() ) : $loop->the_post();
                            get_template_part( 'content', 'boardgraphies' );
                        endwhile;
                    ?>
                </div>
                <div class="col-lg-7 col-md-7 col-sm-7">
                    <?php
                        ...
                        $loop = new WP_Query( $args );
                        while ( $loop->have_posts() ) : $loop->the_post();
                            get_template_part( 'content', 'boardpictures' );
                        endwhile;
                    ?>
                </div>
            </div>
