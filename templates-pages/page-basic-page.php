              ...
              <div class="paragraph">
                  ...
                  <?php
                      ...
                      endwhile;
                        ...
                        if($id == "1641") {
                          //echo do_shortcode('[contact-form-7 id="2406" title="Mortgage Campaign Form"]'); 
                          // echo dynamic_sidebar("home-middle");   
                        } else if($id == "1215") {
                          //echo do_shortcode('[contact-form-7 id="2442" title="Affordable Campaign Form"]'); 
                          // echo dynamic_sidebar("home-middle");   
                        } else if($id == "213") {
                          echo do_shortcode('[contact-form-7 id="2834" title="Client Contact Center"]'); 
                          // echo dynamic_sidebar("home-middle");   
                        }
                    ?>
